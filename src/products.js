...
module.exports = [
  ...
  },
  {
    ...
    features: [
      ...
      ['🪄', 'Magic eraser', 'Click an unwanted object and it\'s gone — AI fills the background. Undo built in.'],
      ['🧠', 'Models in the installer', 'All AI models ship inside the app — nothing downloads, offline from first launch.'],
    ...
    compRows: [
      ...
      ['Offline', 'Yes — models ship in the installer', 'No'],
    ...
    steps: [
      ['Buy once on Whop', 'One-time $24 gets you the packaged Windows or Mac installer with 1-click setup and updates.'],
      ['Nothing to set up', 'Every AI model is bundled in the installer — no downloads, offline from the first launch.'],
    ...
    faq: [
      ...
      ['Do my photos get uploaded?', 'Never. Inference runs on your CPU via onnxruntime. Every AI model ships inside the installer, so the app makes zero network calls.'],
  ...
  {
    slug: 'orgtree', brand: 'WholeTeam', repo: 'wholeteam-mvp', price: 19, icon: '🌳',
    stamp: 'Desktop app · Windows + macOS · Admin + Member editions',
    tagline: 'Org chart, team chat, file library and time clock — all on your own network.',
    oneliner: 'LAN-first team platform: drag-drop org chart with scenario planning, auto-generated department chat channels, shared file libraries and a PIN time clock. One payment covers your whole team.',
    competitor: 'Lucidchart', compPrice: '$7.95/mo', compYr: 95,
    heroLead: 'Lucidchart charges $7.95/month per editor just to keep an org chart current — and it stops at the chart. WholeTeam (formerly Orgtree) puts the org chart, team chat with auto-generated department channels, per-department file libraries and a PIN time clock into one desktop app that runs entirely on your own network. Install WholeTeam Admin on the owner\'s machine and WholeTeam Member on everyone else\'s — $19 once, no seats, and your chats, files and hours never touch the cloud.',
    features: [
      ['🌳', 'Drag-drop org chart', 'CSV import, auto-layout, drag to reparent, department color coding — plus scenario planning to model a reorg before you announce it.'],
      ['💬', 'Team chat, no server bill', 'Auto-generated department channels plus direct messages, hosted by the Admin machine on your LAN — no Slack subscription, no cloud.'],
      ['📁', 'Department file libraries', 'Each department gets a shared 300MB library that syncs to a plain folder in Documents on every Member machine.'],
      ['⏱️', 'PIN time clock', 'Employees clock in with a PIN; hours and idle-based activity % land on the Admin machine — not on a surveillance dashboard in someone else\'s cloud.'],
      ['🖥️', 'Admin + Member editions', 'Admin hosts everything on the owner\'s machine — and is the only place salary data ever lives. Member connects for chat, files, self-service profile and clock-in.'],
      ['🔒', 'Closed-loop by design', 'Chats, files and hours stay on your network. Zero cloud accounts, zero telemetry.'],
      ['🌐', 'Remote workers via Tailscale', 'Off-site employees connect over a free private Tailscale network exactly as if they were on the office LAN.'],
      ['📤', 'PDF & PNG export', 'Print-ready org charts in one click, with photos or initials per person.'],
    ],
    compRows: [
      ['Price', '$19 once', '$7.95/user/mo ($95/user/yr)'],
      ['Cost over 3 years, 3 editors', '$19', '$855'],
      ['Org chart + auto-layout', 'Included', 'Included'],
      ['Team chat', 'Included — LAN-hosted channels & DMs', 'No'],
      ['Shared file libraries', 'Included — one per department', 'No'],
      ['Time clock', 'Included — PIN clock-in + activity %', 'No'],
      ['Where your data lives', 'Your own machines', 'Their cloud'],
      ['Source code', 'MIT, on GitHub', 'Closed'],
    ],
    payback: 'Against a 3-editor Lucidchart team, WholeTeam pays for itself in under a month — and it replaces the chat, file-sharing and time-clock subscriptions Lucidchart never covered.',
    steps: [
      ['Buy once, grab both installers', 'One $19 payment covers your whole team — download WholeTeam Admin for the host machine and WholeTeam Member for employees, right on this page.'],
      ['Set up the Admin host', 'Install Admin on the owner or manager\'s machine and import your team from CSV — it starts hosting chat, files and the time clock for the office.'],
      ['Connect your team', 'Install Member on each employee\'s machine — it connects to the Admin host on your LAN (or over Tailscale for remote workers) and everyone\'s in.'],
    ],
    faq: [
      ['What\'s the difference between WholeTeam Admin and Member?', 'Admin is for the owner or manager — install it on one machine. It hosts the org chart, chat, files and time clock for everyone else, and it\'s the only place salary data ever lives. Member is for employees — it connects to the Admin install for chat, the file library, self-service profile and PIN clock-in.'],
      ['Do I need a license per employee?', 'No — WholeTeam Admin is a one-time $19 purchase for the host machine, and employee Member installs are covered under the same purchase. There\'s no per-seat subscription.'],
      ['Does anything ever touch the cloud?', 'No. Chats, files and hours stay on your own network. Remote employees connect back to the Admin machine over Tailscale — a private, encrypted overlay network — not through a public cloud service.'],
      ['Is the activity tracking spyware?', 'No — there are no screenshots, no keylogging, no webcam. The activity % is idle-based only: it measures whether the machine was in use while clocked in, and it\'s visible to your admin, not to a third party.'],
      ['Wasn\'t this called Orgtree?', 'Yes — WholeTeam is Orgtree grown up. The org chart builder is still here, now alongside team chat, department file libraries and the PIN time clock. Same one-time price.'],
      ['Is the source code available?', 'Yes — MIT source at github.com/bensblueprints/wholeteam-mvp. The $19 buys the packaged Admin + Member installers and updates.'],
    ],
    downloads: {
      repo: 'bensblueprints/wholeteam-mvp',
      version: '1.8.0',
      editions: [
        {
          key: 'admin', name: 'WholeTeam Admin', role: 'Host — install on the owner or manager\'s machine. Runs the org chart, chat, files and time clock for everyone.',
          assets: {
            win: 'https://github.com/bensblueprints/wholeteam-mvp/releases/download/v1.8.0/WholeTeam.Setup.1.8.0.exe',
            mac: 'https://github.com/bensblueprints/wholeteam-mvp/releases/download/v1.8.0/WholeTeam-1.8.0.dmg',
            macArm: 'https://github.com/bensblueprints/wholeteam-mvp/releases/download/v1.8.0/WholeTeam-1.8.0-arm64.dmg',
          },
        },
        {
          key: 'member', name: 'WholeTeam Member', role: 'Employees — install on each team member\'s machine. Connects to your Admin host for chat, files and clock-in.',
          assets: {
            win: 'https://github.com/bensblueprints/wholeteam-mvp/releases/download/v1.8.0/WholeTeam.Member.Setup.1.8.0.exe',
            mac: 'https://github.com/bensblueprints/wholeteam-mvp/releases/download/v1.8.0/WholeTeam.Member-1.8.0.dmg',
            macArm: 'https://github.com/bensblueprints/wholeteam-mvp/releases/download/v1.8.0/WholeTeam.Member-1.8.0-arm64.dmg',
          },
        },
      ],
    },
