---
slug: self-hosted-linktree-alternative
title: Self-Hosted Linktree Alternative — LinkLeaf (Open Source, Docker-Ready)
description: Want a link-in-bio page on your own domain and server? LinkLeaf is MIT-licensed and Docker-ready. Self-host in minutes, keep every byte of your analytics.
---

# The Open-Source, Self-Hostable Linktree Alternative
...
Grab the open-source, MIT-licensed code and deploy with Docker on your own domain — or start free on the hosted version at **[linkleaf.im](https://linkleaf.im)** and move to self-hosting whenever you want. Either way, your page and your data stay yours.
