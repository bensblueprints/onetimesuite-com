...
module.exports = [
  ...
  {
    slug: 'inkseal', brand: 'Inkseal', repo: 'inkseal', price: 49, icon: '✍️',
    tagline: 'Self-hosted e-signatures. Unlimited envelopes, verifiable audit trail, pay once.',
    oneliner: 'Upload a PDF, place fields, route signers, get a flattened audit-trailed document — on your own box.',
    ...
    features: [
      ...
      ['🔗', 'Hash-chained audit trail', 'Every event is chained with sha256(prev_hash + event), rooted in the original document\'s own hash. One-click Verify recomputes the whole chain and pinpoints any tampering.'],
    ...
    payback: 'Five months of DocuSign Personal pays for Inkseal outright — and removes the envelope cap entirely. Everything after that is free, forever.',
    steps: [
      ['Buy once on Whop', 'One-time $49 for the packaged Windows installer — no subscription, no per-envelope billing, ever.'],
      ...
      ['Upload, place fields, send', 'Drop a PDF, drag fields onto it, route signers in order or all at once. Download the flattened, audit-trailed final document when everyone has signed.'],
    ],
    faq: [
      ['Is it really free on GitHub?', 'Yes — the full source is MIT-licensed at github.com/bensblueprints/inkseal and always will be. The $49 buys the signed Windows installer, 1-click setup and updates instead of running git clone yourself.'],
      ...
      ['How does the audit trail compare to DocuSign\'s?', 'Every event (created, sent, viewed, consented, signed, completed, declined) is chained with sha256(prev_hash + event), rooted in the SHA-256 of the original uploaded PDF. Anyone can hit Verify and recompute the whole chain — no need to take a vendor\'s word for it. DocuSign\'s certificate is solid too, but it\'s proprietary; you trust them, not math you can check.'],
